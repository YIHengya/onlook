...
CREATE TABLE "legacy_subscriptions" (
	...
	CONSTRAINT "legacy_subscriptions_email_unique" UNIQUE("email")
);
--> statement-breakpoint
ALTER TABLE "legacy_subscriptions" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
ALTER TABLE "subscriptions" ALTER COLUMN "status" SET DATA TYPE "public"."subscription_status";--> statement-breakpoint
