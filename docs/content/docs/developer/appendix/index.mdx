...
# Anthropic - Enables AI chat. Other providers may be supported in the future.
ANTHROPIC_API_KEY="<Your api key from https://console.anthropic.com/settings/keys>"

# Google Gemini - Enables Gemini AI models for chat
GOOGLE_API_KEY="<Your api key from https://aistudio.google.com/app/apikey>"
# Alternative environment variable name for Gemini API key
